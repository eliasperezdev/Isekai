...
const fs = require("fs");
const ubicacionPlantilla = require.resolve("../src/views/factura.html");
...
const createTicket = (order) => {
    

    const formateador = new Intl.NumberFormat("en", { style: "currency", "currency": "ARS" });
